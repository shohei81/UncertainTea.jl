...
`multinomial`, `orderedlogistic` (ordinal outcomes), and `zeroinflatedpoisson` / `zeroinflatednegativebinomial` (excess-zero counts); the vector/structured families `dirichlet`, diagonal `mvnormal`,
